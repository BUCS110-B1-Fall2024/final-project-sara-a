...
class Controller:
    ...
    def start_menu(self):
        ...
        while running:
            ...
            self.screen.blit(instruct_text, (140, 400))
            pygame.display.flip()
    ...
    def gameoverloop(self, winner):
        ...
        while running:
            ...
            instruct_text = font.render("Press S to start again or E to end game", True, (255, 255, 255))
            self.screen.blit(win_text, (200, 200))
            self.screen.blit(instruct_text, (60, 400))
            pygame.display.flip()
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    pygame.quit()
